...
public class Client {
	...
	/*
	 * public void Connect(){ try { Socket socket = new Socket("localhost",
	 * 1994); PrintStream ps = new PrintStream(socket.getOutputStream());
	 * ps.println("khanh toan");
	 * 
	 * BufferedReader br = new BufferedReader(new
	 * InputStreamReader(socket.getInputStream())); String response =
	 * br.readLine(); if(response != null){
	 ...
	 * java Client > java Client username portNumber > java Client username
	 * portNumber serverAddress at the console prompt If the portNumber is not
	 * specified 1500 is used If the serverAddress is not specified "localHost"
	 * is used If the username is not specified "Anonymous" is used > java
	 * Client is equivalent to > java Client Anonymous 1500 localhost are
	 * eqquivalent
	 *
